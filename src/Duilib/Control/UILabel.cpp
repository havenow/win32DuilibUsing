	...
	void CLabelUI::PaintText(HDC hDC)
	{
		...
		if (IsEnabled()) 
		{
			if (m_bShowHtml)
				...
				CRenderEngine::DrawText(hDC, m_pManager, rc, m_sText, m_dwTextColor, m_iFont, DT_SINGLELINE | m_uTextStyle, m_bDrawTextPlus);
		...
		else 
		{
			if (m_bShowHtml)
				...
				CRenderEngine::DrawText(hDC, m_pManager, rc, m_sText, m_dwDisabledTextColor, m_iFont, DT_SINGLELINE | m_uTextStyle, m_bDrawTextPlus);
		}
	}
